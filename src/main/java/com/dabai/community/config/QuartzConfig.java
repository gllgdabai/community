...
import com.dabai.community.quartz.AlphaJob;
import com.dabai.community.quartz.PostScoreRefreshJob;
...
/** 只在第一次被调用时有效，封装的信息初始化到数据库中，以后都访问数据库
 * @author
 * @create 2022-04-15 19:08
 */
@Configuration
